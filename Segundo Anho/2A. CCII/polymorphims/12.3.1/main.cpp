// Asignamos la dirección de un objeto de clase derivada a un puntero de clase base
// y explicamos que el compilador C++ permite esta asignación, porque un objeto de clase derivada
// es un objeto de clase base.
...
int main()
{
     ...
     cout << "\n\nCALLING VIRTUAL FUNCTION TOSTRING WITH DERIVED-CLASS "
          ...
          << "TOSTRING FUNCTION:\n"
          << basePlusCommissionEmployeePtr->toString(); // derived versio
