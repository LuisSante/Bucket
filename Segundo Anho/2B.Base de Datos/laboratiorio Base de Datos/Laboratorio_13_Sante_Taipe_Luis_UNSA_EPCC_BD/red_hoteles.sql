DROP DATABASE IF EXISTS `RED_HOTELES`;

CREATE DATABASE `RED_HOTELES`;
...
ALTER TABLE `CLIENTE` ADD FOREIGN KEY (ID_CLIENTE) REFERENCES `TELEFONO_CLIENTE`(`ID_CLIENTE`);
ALTER TABLE `RESERVA` ADD FOREIGN KEY (ID_CLIENTE) REFERENCES `CLIENTE`(`ID_CLIENTE`);
ALTER TABLE `CUARTO` ADD FOREIGN KEY (NUMERO_CUARTO) REFERENCES `D_ESTANDAR`(`NUMERO_CUARTO`);
ALTER TABLE `CUARTO` ADD FOREIGN KEY (NUMERO_CUARTO) REFERENCES `D_LUJO`(`NUMERO_CUARTO`);
ALTER TABLE `CUARTO` ADD FOREIGN KEY (NUMERO_CUARTO) REFERENCES `D_SUPERLUJO`(`NUMERO_CUARTO`);
ALTER TABLE `CUARTO` ADD FOREIGN KEY (NUMERO_CUARTO) REFERENCES `CUARTO_RESERVA`(`NUMERO_CUARTO`);
...
ALTER TABLE `CLIENTE` ADD FOREIGN KEY (ID_CLIENTE) REFERENCES `CLIENTE_NACIONAL`(`ID_CLIENTE`);
ALTER TABLE `CLIENTE` ADD FOREIGN KEY (ID_CLIENTE) REFERENCES `CLIENTE_EXTRANJERO`(`ID_CLIENTE`);
